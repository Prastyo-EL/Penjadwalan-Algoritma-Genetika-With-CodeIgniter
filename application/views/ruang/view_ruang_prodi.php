<div class="">
  ...
  <div class="clearfix"></div>
    ...
    <form method="post" action="<?=base_url().'pengelolaan/ruang_prodi'?>">
      ...
      <a href="<?=base_url() . 'pengelolaan/ruang_prodi';?>">
      ...
      if (!empty($data)) {
        foreach ($data as $key => $value) { 
          ...
          <tr>
            ...
            <td><?=$value['prodi']?></td>
            <td align="center">
            <a href="<?=$url_pilih_prodi?>" id="<?=$value['id']?>" class="edit_prodi"><button class="btn btn-xs btn-round btn-warning"><i class="fa fa-edit"></i> Ubah </button></a>
            </td>
          </tr>
          <?php 
        }
